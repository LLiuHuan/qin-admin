...
export const circularProgressTickSpec: ICircularProgressChartSpec & {
...
export const liquidChartSmartInvertSpec: ILiquidChartSpec & {
  indicator: IIndicatorSpec;
} = {
  type: 'liquid',
  valueField: 'value',
...
export const stackedDashAreaSpec: IAreaChartSpec = {
  ...
  data: {
    values: [
      ...
      { month: 'May', country: 'China', value: 12_043 },
      { month: 'May', country: 'USA', value: 12_998 },
      { month: 'Jun', country: 'Africa', value: 5432 },
      { month: 'Jun', country: 'EU', value: 3417 },
      { month: 'Jun', country: 'China', value: 15_067 },
      { month: 'Jun', country: 'USA', value: 12_321 },
      { month: 'Jul', country: 'Africa', value: 13_701 },
      { month: 'Jul', country: 'EU', value: 5231 },
      { month: 'Jul', country: 'China', value: 10_119 },
      { month: 'Jul', country: 'USA', value: 10_342 },
      { month: 'Aug', country: 'Africa', value: 4008, forecast: true },
      { month: 'Aug', country: 'EU', value: 4572, forecast: true },
      { month: 'Aug', country: 'China', value: 12_043, forecast: true },
      { month: 'Aug', country: 'USA', value: 22_998, forecast: true },
      { month: 'Sept', country: 'Africa', value: 18_712, forecast: true },
      { month: 'Sept', country: 'EU', value: 6134, forecast: true },
      { month: 'Sept', country: 'China', value: 10_419, forecast: true },
      { month: 'Sept', country: 'USA', value: 11_261, forecast: true },
    ],
  },
  stack: true,
  xField: 'month',
