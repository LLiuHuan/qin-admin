...
// import type { UploadChangeParam } from '@arco-design/web-vue';

import { ref } from 'vue';

import { Page, VCropper } from '@qin/common-ui';

import { Button, Card, Select, Upload } from '@arco-design/web-vue';
      ...
      <div class="image-cropper-container">
        <div class="cropper-ratio-display">
          ...
          <Upload
            ...
            :on-before-upload="selectImgFile"
          >
            <Button>上传图片</Button>
          </Upload>
        </div>
