 ...
 * @LastEditTime: 2025-05-27 15:54:06
...
async function bootstrap(namespace: string) {
  ...
  // 注册Arco提供的v-loading和v-spinning指令
  registerLoadingDirective(app, {
    loading: false, // Arco提供的v-loading指令和Element Plus提供的v-loading指令二选一即可，此处false表示不注册Arco提供的v-loading指令
    spinning: 'spinning',
  });
