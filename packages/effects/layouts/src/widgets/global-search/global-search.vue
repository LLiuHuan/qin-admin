...
<template>
  <div>
      ...
      <template #title>
        <div class="flex items-center">
          ...
          <input
            ...
            class="ring-none placeholder:text-muted-foreground outline-hidden w-[80%] rounded-md border border-none bg-transparent p-2 pl-0 text-sm font-normal ring-0 ring-offset-transparent focus-visible:ring-transparent"
          />
        </div>
      </template>
    ...
    <div
      class="md:bg-accent outline-hidden group flex h-8 cursor-pointer items-center gap-3 rounded-2xl border-none bg-none px-2 py-0.5"
      @click="toggleOpen()"
    >
      <Search
