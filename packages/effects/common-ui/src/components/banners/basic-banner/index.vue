<!-- 基础横幅组件 -->
<!-- https://github.com/Daymychen/art-design-pro/blob/main/src/components/core/banners/art-basic-banner/index.vue -->
<script setup lang="ts">
import type { BasicMeteor, BasicPannerProps } from '../types';
...
// 组件属性默认值设置
const props = withDefaults(defineProps<BasicPannerProps>(), {
  height: '11rem',
  titleColor: 'white',
  subtitleColor: 'white',
 ...
 * @returns 流星数据数组
 */
function generateMeteors(count: number): BasicMeteor[] {
  // 计算每个流星的区域宽度
